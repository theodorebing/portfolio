  ...
  return (
    <footer className="footer">
      <div className="footer-container">
        <a href="https://www.linkedin.com/in/theodorebing" target="_blank" rel="noreferrer">
          <img className="footer-icon" src="https://img.icons8.com/color/480/000000/linkedin.png" alt="Linkedin" />
        </a>
        <a href="https://github.com/theodorebing" target="_blank" rel="noreferrer">
          <img className="footer-icon" src="https://img.icons8.com/fluency/240/000000/github.png" alt="Github" />
        </a>
        <a href="https://twitter.com/BingTheodore" target="_blank" rel="noreferrer">
